...
/* 
Este filtro se ejecuta en cada request protegida, excepto en /auth/login. Su función es:
    Leer el token JWT de la cabecera Authorization.
    Validarlo con tu SECRET_KEY.
    Si es válido, extraer el username y los roles y establecer el contexto de seguridad (SecurityContextHolder), como si el usuario hubiera hecho login.
*/
